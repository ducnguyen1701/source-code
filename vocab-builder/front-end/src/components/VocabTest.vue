<template>
    <div>
      ...
      <form action="#" @submit.prevent="onSubmit">
        <div class="ui labeled input fluid">
          ...
          <input type="text" readonly :disabled="testOver" :value="currWord.german" required/>
        </div>
        <div class="ui labeled input fluid">
          <div class="ui label">
            <i class="united kingdom flag"></i> English
          </div>
          <input type="text" placeholder="Enter word..." v-model="english" :disabled="testOver" autocomplete="off" required/>
        </div>
        ...
        <div class="ui labeled input fluid">
          ...
          <input type="text" placeholder="Enter word..." v-model="vietnam" :disabled="testOver" autocomplete="off" required/>
        </div>
        ...
        <div class="ui labeled input fluid">
          ...
          <input type="text" placeholder="Enter word..." v-model="france" :disabled="testOver" autocomplete="off" required />
        </div>
  ...
  export default {
    ...
    methods: {
      onSubmit: function() {
        if (this.english === this.currWord.english , this.france === this.currWord.france ) {
